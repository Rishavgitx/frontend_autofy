                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 10),
                                          Text(
                                            '${DateFormat('h:mm a').format(DateTime(2022, 1, 1, _time.hour, _time.minute))}',
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontWeight: FontWeight.w700,
                                                fontSize: 13.5),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            'shared',
                            style: TextStyle(
                                height: 4, color: Colors.green, fontSize: 15),
                          ),
                          SizedBox(width: 110),
                          Image(
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  children: <Widget>[
                    Container(
                      margin: EdgeInsets.only(bottom: 50,right: 60),
                      height: 12,
                      width: 8,
                      decoration: BoxDecoration(
                ...
                Column(
                  children: <Widget>[
                    Padding(
                      padding: EdgeInsets.only(right: 40, bottom: 100),
                      child: Container(
                        child: Text(
                          location1,
                          style: TextStyle(
